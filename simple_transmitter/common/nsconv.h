...
#ifdef _WIN32
inline gc::simple_ptr<char, gc::clgdef_destroy> _transcode(const wchar_t* _Source)
{
    ...
    return  gc::simple_ptr<char, gc::clgdef_destroy>(target);
}

inline gc::simple_ptr<wchar_t, gc::clgdef_destroy> _transcode(const char* _Source)
{
    ...
    return gc::simple_ptr<wchar_t, gc::clgdef_destroy>(target);
}
...
}; // namespace: simplepp_1_0_2012_9::nsc
}; // namespace: simplepp_1_0_2012_9
